        ...
        const messages = [
          {
            ...
            content: [
              {
                type: "text",
                text: `Detalhe tecnicamente a peça de vestuário desta foto como se fosse uma ficha técnica de moda profissional. Analise caimento, gola, mangas, corpo, estampa, acabamentos e todos os detalhes visíveis.

PRODUTO: ${productInfo.name}${productInfo.title ? ` - ${productInfo.title}` : ''}
REF_ID: ${productInfo.ref_id || 'N/A'}

IMPORTANTE: Sua análise deve ter NO MÍNIMO 300 palavras. Seja detalhado e técnico, descrevendo:
- Modelagem e caimento da peça
- Detalhes da gola e acabamentos
- Características das mangas
- Estrutura do corpo da peça
- Qualquer estampa ou aplicação visível
- Acabamentos e costuras
- Qualidade visual das imagens
- Sugestões de uso e estilo

Crie uma análise técnica profissional e completa focando nos detalhes visíveis das imagens.`
              },
              ...images.map(img => ({
                type: "image_url",
                image_url: {
