...
import { 
  ...
  getChildrenStatusColor,
  getChildrenStatusText
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {categories.map((category) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getChildrenStatusColor(category.has_children)}`}>
                    {getChildrenStatusText(category.has_children)}
                  </span>
                </td>
                <td className="px-4 py-3">
                  <div className="text-sm text-gray-900">
