...
async function updateAgentCategorySpecific() {
  let connection;
  ...
  try {
    ...
    console.log('🔧 Atualizando agente com análise específica por categoria...');
...
**TIPO DE ROUPA - Baseado na categoria e análise visual:**
Se a categoria for "Camiseta" ou similar:
- Camiseta (para camisetas básicas, sem gola)
- Camiseta Polo (para camisetas com gola polo/colarinho)

Se a categoria for "Blusa" ou similar:
- Blusa (para blusas femininas)
- Camisa (para camisas masculinas)

Se a categoria for "Moletom" ou similar:
- Moletom (para moletons/casacos de moletom)

Se a categoria for "Jaqueta" ou similar:
- Jaqueta (para jaquetas e casacos)

Se a categoria for "Calça" ou similar:
- Calça (para calças em geral)

Se a categoria for "Short" ou similar:
- Short (para shorts e bermudas)

Se a categoria for "Vestido" ou similar:
- Vestido (para vestidos)

Se a categoria for "Saia" ou similar:
- Saia (para saias)

Outras opções disponíveis:
- Regata, Top, Cardigã, Suéter, Casaco, Produto de Vestuário
...
Tipo de Roupa: [escolha baseada na categoria e análise visual]
Produto de Vestuário: [mesmo valor do Tipo de Roupa]
...
- Para categoria "Camiseta": analise se tem gola polo (Camiseta Polo) ou não (Camiseta)
...
- Use "N/A" apenas se realmente não conseguir identificar`;
    ...
    // Atualizar o agente com o prompt específico por categoria
    ...
    console.log('✅ Agente atualizado com análise específica por categoria!');
