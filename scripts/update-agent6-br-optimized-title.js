...
async function updateAgent6BrOptimizedTitle() {
  let connection;
  ...
  try {
    ...
    // Novo system prompt usando <br> e título otimizado
...
1. Apresentação (baseada na análise visual e título otimizado)
...
- NÃO use formatação visual além das tags básicas`;
    ...
    console.log('Atualizando agente ID 6 para usar <br> e título otimizado...');
    
    const [updateResult] = await connection.execute(`
      UPDATE agents 
      SET 
        name = 'Especialista em Descrições HTML com Título Otimizado',
        system_prompt = ?,
        guidelines_template = ?,
        max_tokens = 2000,
        temperature = 0.7,
    ...
    console.log('Estrutura HTML com <br>:');
