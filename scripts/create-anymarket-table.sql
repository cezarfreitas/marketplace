-- Script para criar/corrigir a tabela anymarket
-- Execute este script no seu banco de dados MySQL

-- Remover a tabela se ela existir (CUIDADO: isso apagará todos os dados!)
-- DROP TABLE IF EXISTS anymarket;

-- Criar a tabela anymarket com as colunas necessárias
