...
async function updateAgent6BasicHTML() {
  let connection;
  ...
  try {
    ...
    // Novo system prompt sem emojis e com HTML básico
...
- NÃO use formatação visual além das tags básicas`;
    ...
    console.log('Atualizando agente ID 6 para HTML básico sem emojis...');
    
    const [updateResult] = await connection.execute(`
      UPDATE agents 
      SET 
        name = 'Especialista em Descrições HTML Básico',
        system_prompt = ?,
        guidelines_template = ?,
        max_tokens = 2000,
        temperature = 0.7,
    ...
    console.log('Estrutura HTML básica:');
    console.log('   <b>APRESENTAÇÃO</b>');
    console.log('   <hr>');
    console.log('   <b>CARACTERÍSTICAS</b>');
    console.log('   <ul><li>...</li></ul>');
    console.log('   <hr>');
    console.log('   <b>BENEFÍCIOS</b>');
    console.log('   <hr>');
    console.log('   <b>COMO CUIDAR DO PRODUTO</b>');
    console.log('   <hr>');
    console.log('   <b>PERGUNTAS FREQUENTES</b>');
    console.log('   <ul><li>...</li></ul>');
    console.log('   <hr>');
    console.log('   <b>GARANTA O SEU AGORA!</b>');
