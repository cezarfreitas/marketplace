...
async function checkSkusVtexStructure() {
  let connection;
  ...
  try {
    ...
    // Verificar se a tabela skus_vtex existe
    ...
    if (tables.length === 0) {
      console.log('❌ Tabela skus_vtex não existe');
      return;
    }

    console.log('✅ Tabela skus_vtex encontrada');
    ...
    console.log('📋 Estrutura da tabela skus_vtex:');
    columns.forEach(col => {
