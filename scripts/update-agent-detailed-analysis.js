...
async function updateAgentDetailedAnalysis() {
  let connection;
  ...
  try {
    ...
    console.log('🔧 Atualizando agente com análise detalhada de características...');
...
Responda EXATAMENTE no formato abaixo, sendo MUITO ESPECÍFICO:
...
- Seja consistente entre as imagens fornecidas`;
    ...
    // Atualizar o agente com análise detalhada
    ...
    console.log('✅ Agente atualizado com análise detalhada!');
